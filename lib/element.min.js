    ...
    Object.defineProperties(element, {
            ...
            value: (state, obj) => {
                if (renderingStatus.atClient) {
                    if (element.hasAttribute('data-x-state')) {
                        ...
                        Object.assign(state, JSON.parse(element.getAttribute('data-x-state')));
        ...
        _hidden: {
            set: (value) => {
                ...
                if (value) {
                    element.classList.remove('js-dsp-inblck');
                    element.classList.add('js-dsp-none');
                }
                else {
                    element.classList.remove('js-dsp-none');
                    element.classList.add('js-dsp-inblck');
                }
            },
            get: () => {
                return element.classList.contains('js-dsp-none');
            }
        }
    });
